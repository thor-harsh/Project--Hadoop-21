...
**In this Project we will be using Spark SQL to create a dataframe instead of RDD to count the average number of friends associated with each age group. Then we also sort the friends count by age and also added alias for that column**
